  ...
  return (
    <>
      ...
      <div className="fixed bottom-8 right-8 z-50 flex gap-3">
        <button
          onClick={togglePlay}
          className="backdrop-blur-xl bg-white/20 hover:bg-white/30 rounded-full p-4 shadow-lg border border-white/30 transition-all duration-300 hover:scale-110"
